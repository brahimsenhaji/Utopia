...
if(isset($_POST['upload-btn'])){
    ...
    $sql = "INSERT INTO properties (user_id,title, category, floors, rooms, kitchen, bathroom, price, city, street_name, house_number) 
            VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_stmt_init($conn);
    if (mysqli_stmt_prepare($stmt, $sql)) {
        mysqli_stmt_bind_param($stmt, "issiiiiisss", $userId, $title, $category, $floors, $rooms, $kitchen, $bathroom, $price, $city, $street_name, $house_number);
